...
public class ReaderConsumerServiceImplUnitTest {
    ...
    private static final String READER_JSON = "[{\"id\":1,\"name\":\"reader1\",\"favouriteBook\":{\"author\":\"Milan Kundera\",\"title\":\"The Unbearable Lightness of Being\"}," +
    ...
    private static final String BASE_URL = "http://localhost:8080/readers";
