package com.example.webClientDemo.webclient.status;
...
import com.example.webClientDemo.webclient.status.exception.CustomBadRequestException;
import com.example.webClientDemo.webclient.status.exception.CustomServerErrorException;
