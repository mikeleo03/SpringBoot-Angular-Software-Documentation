...
public class EmployeeController {
    ...
    */
    ...
    /**
     * This method is responsible for downloading a PDF file containing employee data from the server.
     * The PDF file is generated by processing the uploaded CSV file containing employee data.
     * The generated PDF file is then returned as a response entity with appropriate headers for PDF download.
     *
     * @param file The {@link MultipartFile} object representing the CSV file to be processed and converted into a PDF file.
     * @return A {@link ResponseEntity} containing the generated PDF file as a byte array, with appropriate headers for PDF download.
     * @throws IOException If an error occurs while reading the CSV file.
     * @throws DocumentException If an error occurs while generating the PDF file.
     */
    @PostMapping("/downloadPdf")
    public ResponseEntity<byte[]> downloadPdfFromCsv(@RequestParam("file") MultipartFile file) {
        try {
            byte[] pdfBytes = employeeService.generatePdfFromCsv(file);
